...
/**
 * Class Comet_6_V2 - a type of comet that has the properties
 ...
 * @version 2016.3.14
 */
public class Comet_6_V2 extends Comet
{    
    Random random = new Random();
    /**
    * Constructor for objects of class Comet_6_V2
    *
    ...
    * 
    */
    public Comet_6_V2(int xPos, int yPos, int xVel, int yVel, int objectDiameter, Color objectColor, int objLife, Universe theUniverse)
    {
    ...
    **/
    ...
    {      
        System.out.println("Lifetime before change = " + lifeTime);
        if(lifeTime > 0){
            lifeTime *= 0.50;     // gets rid of 50% of the comets life time
        } 
        System.out.println("Lifetime after change = " + lifeTime);
    }
}
